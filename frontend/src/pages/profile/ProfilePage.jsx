...
const ProfilePage = () => {
    ...
    const { data: user, isLoading, refetch, isRefetching } = useQuery({
        ...
        queryFn: async () => {
            ...
            if (!res.ok) throw new Error(data.error || "could not get user");
            return data;
        }
    })
                    ...
                    <>
                        <div className='flex gap-10 px-4 py-2 items-center'>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <span className='text-sm text-slate-500'>{user.createdPosts.length} posts</span>
                            </div>
                        </div>
                        ...
                        <div className='relative group/cover'>
                            ...
                            {/* USER AVATAR */}
                            <div className='avatar absolute bottom-0 translate-y-[50%] left-4'>
                        ...
                        <div className='flex flex-col gap-4 mt-14 px-4'>
                            ...
                            <div className='flex gap-2 flex-wrap'>
                                ...
                                <div className='flex gap-2 items-center'>
                                    ...
                                    <span className='text-sm text-slate-500'>Joined {getJoinedSince(user?.createdAt)}</span>
                                </div>
                            </div>
